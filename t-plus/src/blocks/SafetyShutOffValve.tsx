...
import { ISafetyShutOffValve } from "@/interface/shapes/SafetyShutOffValve";
...
interface ISafetyShutOffValveProps {
  block: ISafetyShutOffValve;
}

const SafetyShutOffValve = ({ block }: ISafetyShutOffValveProps) => {
  ...
  return (
    <>
      <Group
        x={block.x + block.prefWidth - block.prefWidth / 10}
...
export default SafetyShutOffValve;
